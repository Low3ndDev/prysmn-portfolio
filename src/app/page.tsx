...
const demos = [
  {
    ...
    description: 'Clean, trust-focused design for a licensed residential and commercial electrician. Dark blue + gold palette.',
    gradient: 'from-blue-900 to-blue-700',
    icon: Zap,
    features: ['Lead capture form', 'Service cards', 'Trust badges', 'Testimonials'],
  },
  {
    href: '/coastline-landscaping',
    title: 'Coastline Landscaping',
    trade: 'Landscaper',
    location: 'Gold Coast, QLD',
    type: 'Multi-Section Page',
    description: 'Visual-first design for a premium landscaping business. Green + cream palette with gallery grid and process timeline.',
  ...
  },
  {
    ...
    description: 'Urgency-driven design for an emergency plumbing service. Bold red accents with blog-style tips section.',
